...
export async function computeIntegrityHash(contract) {
  const { integrity, contractNo, stage, deletedAt, modelId, modelName, idCards, idCount, drawings, drawingCount, memo, deposit, ...rest } = contract; // 봉인값·채번·진행상태·휴지통·모델표시·신분증·협의도면·메모·계약금입금(관리용)은 내용 변경과 무관하므로 제외
