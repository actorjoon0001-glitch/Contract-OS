...
export const Contracts = {
  list({ q = '' } = {}) {
    if (q) {
      ...
      return db
        .prepare(
          `SELECT id, contract_no, status, json_extract(data, '$.stage') AS stage, json_extract(data, '$.signatures.approval.signedAt') AS approval_at, client_name, site_address, showroom, salesperson, contract_date, total_amount, updated_at
           FROM contracts
